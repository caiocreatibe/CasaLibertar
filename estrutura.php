...
<div id="pageServicos" class="page">
<div id="traco"></div>
	<header>
			<nav id="mainMenu">
			<figure>
...
<script type="text/javascript" src="js/carrega.js"></script>

<div id="galeriaExterno">
	<div id="containerGaleriaExterno"></div>
	<div id="carregaGaleriaExterno"></div>
</div>
	...
	<div class="galeria">
		<br>
		<h3>Conheça o Visual do Painel</h3>
		<ul id="estrutura" class="fotos">
			<li><img src="upload/images/estrutura/estrutura-libertar-1.jpg" alt="Print Screen Be.web painel administrativo de site"></li>
			<li><img src="upload/images/estrutura/estrutura-libertar-2.jpg" alt="Print Screen Be.web painel administrativo de site"></li>
			<li><img src="upload/images/estrutura/estrutura-libertar-3.jpg" alt="Print Screen Be.web painel administrativo de site"></li>
			<li><img src="upload/images/estrutura/estrutura-libertar-4.jpg" alt="Print Screen Be.web painel administrativo de site"></li>
			<li><img src="upload/images/estrutura/estrutura-libertar-5.jpg" alt="Print Screen Be.web painel administrativo de site"></li>
			<li><img src="upload/images/estrutura/estrutura-libertar-6.jpg" alt="Print Screen Be.web painel administrativo de site"></li>
		</ul>
	</div>
